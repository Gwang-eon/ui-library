...
// Types & Data
// ============================================
type Category = 'form' | 'display' | 'datagrid' | 'feedback' | 'navigation' | 'iot' | 'mobile' | 'all';
        ...
        {showCategory('datagrid') && (
          <section className="demo-section">
            ...
            <div className="demo-item full-width">
              ...
              <p className="demo-note">Use the Export button to download data as CSV. This demo uses useRef to access DataGrid methods.</p>
              <div style={{ marginBottom: '12px' }}>
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => {
                    // Note: In real usage, you'd use useRef to get the DataGrid ref
