    ...
    <section className="demo-section">
      ...
      <div className="demo-grid">
        ...
        <div className="demo-item">
          <h3>Timeline</h3>
          <Timeline>
            <Timeline.Item variant="success" title="Device connected" time="2 min ago" />
            <Timeline.Item variant="info" title="Configuration updated" time="5 min ago" />
            <Timeline.Item variant="warning" title="Warning triggered" time="10 min ago" />
            <Timeline.Item variant="error" title="Alert resolved" time="15 min ago" />
          </Timeline>
        </div>
