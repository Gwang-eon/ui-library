...
export interface DataGridProps<TData> {
    ...
    onCopy?: (data: string[][], selectedCells: {
        rowIndex: number;
        columnId: string;
    }[]) => void;
