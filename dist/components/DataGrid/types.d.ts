...
import { Row, Table as TanStackTable, SortingState, ColumnFiltersState, VisibilityState, RowSelectionState, ExpandedState, GroupingState, ColumnOrderState, ColumnPinningState, ColumnSizingState, PaginationState, RowPinningState, ColumnResizeMode, Updater } from '@tanstack/react-table';
...
export interface DataGridLocale {
    ...
    noData: string;
    filterSearch: string;
    filterSearchColumn: string;
    filterMin: string;
    filterMax: string;
    filterMinColumn: string;
    filterMaxColumn: string;
    filterSelect: string;
    filterSelectedCount: string;
