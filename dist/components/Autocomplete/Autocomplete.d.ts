...
export declare const Autocomplete: {
    ({ options, value: controlledValue, defaultValue, onChange, placeholder, loading, disabled, size, multiple, emptyMessage, minChars, filterFn, className, "aria-label": ariaLabel, portal, }: AutocompleteProps): import("react/jsx-runtime").JSX.Element;
    displayName: string;
};
